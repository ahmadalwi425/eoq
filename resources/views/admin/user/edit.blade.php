                ...
                <div class="card-body">
                    <form action="{{$datauser->id}}" method="POST">
                        ...
                        <div class="form-group row" style="margin:20px;">
                            ...
                            <div class="col-sm-10">
                                <input value="{{$datauser->username}}" type="text" name="username" class="form-control" id="username" placeholder="username">
                            </div>
                        </div>
                        <div class="form-group row" style="margin:20px;">
                            <label class="control-label col-sm-2" for="username">Nama Pegawai</label>
                            <div class="col-sm-10">
                                <input value="{{$datauser->nama_pegawai}}" type="text" name="nama_pegawai" class="form-control" id="username" placeholder="Nama Pegawai">
                            </div>
                        </div>
                        <div class="form-group row" style="margin:20px;">
                            <label class="control-label col-sm-2" for="username">Hp Pegawai</label>
                            <div class="col-sm-10">
                                <input value="{{$datauser->hp_pegawai}}" type="number" name="hp_pegawai" class="form-control" id="username" placeholder="Hp Pegawai">
                            </div>
                        </div>
                        <div class="form-group row" style="margin:20px;">
                            <label class="control-label col-sm-2" for="alamat_pegawai">Alamat</label>
                            <div class="col-sm-10">
                                <textarea name="alamat_pegawai" class="form-control" id="" cols="30" rows="10"> {{$datauser->alamat_pegawai}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row" style="margin:20px;">
